    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('document', models.ForeignKey(to='documents.Document', null=True, verbose_name='Document', blank=True)),
                ('parent', models.ForeignKey(to='main.MenuItem', null=True, related_name='children', blank=True)),
            ],
            options={
                'ordering': ['order'],
            },
